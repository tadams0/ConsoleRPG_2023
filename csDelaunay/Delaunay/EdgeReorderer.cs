...
namespace csDelaunay {
	...
	public class EdgeReorderer<T>
    {
		...
		public EdgeReorderer(List<Edge<T>> origEdges, Type criterion) {
		...
		private List<Edge<T>> ReorderEdges(List<Edge<T>> origEdges, Type criterion) {
			int i;
